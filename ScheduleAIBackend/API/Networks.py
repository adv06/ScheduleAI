...
class ActorNetwork(keras.Model):
    def __init__(self, max_action, fc1_dims=256, fc2_dims = 256, n_actions=2, name='actor', chkpt_dir='tmp/sac'):
    ...
    def sample_normal(self, state, reparameterize=True):
        ...
        log_probs = probabilities.log_probs(actions)
...
class ValueNetwork(keras.Model):
    ...
    def call(self, state):
        state_v = self.fc1(state)
        state_v = self.fc2(state_v)
